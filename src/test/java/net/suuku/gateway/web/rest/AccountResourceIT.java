...
import static net.suuku.gateway.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static net.suuku.gateway.test.util.OAuth2TestUtil.authenticationToken;
import static net.suuku.gateway.test.util.OAuth2TestUtil.registerAuthenticationToken;
