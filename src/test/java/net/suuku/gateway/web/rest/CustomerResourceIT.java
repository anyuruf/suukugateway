package net.suuku.gateway.web.rest;

import static net.suuku.gateway.domain.CustomerAsserts.*;
import static net.suuku.gateway.web.rest.TestUtil.createUpdateProxyForBean;
...
import net.suuku.gateway.IntegrationTest;
import net.suuku.gateway.domain.Customer;
import net.suuku.gateway.domain.User;
import net.suuku.gateway.domain.enumeration.Gender;
import net.suuku.gateway.repository.CustomerRepository;
import net.suuku.gateway.repository.EntityManager;
import net.suuku.gateway.repository.UserRepository;
import net.suuku.gateway.service.CustomerService;
...
class CustomerResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "T<N@,MS3R.&!-.]";
    private static final String UPDATED_EMAIL = "~RLgT;@/Er.}U^";
