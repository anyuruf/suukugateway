package net.suuku.gateway.service;

import java.time.Instant;
import java.util.*;
import java.util.stream.Collectors;
import net.suuku.gateway.config.Constants;
import net.suuku.gateway.domain.Authority;
import net.suuku.gateway.domain.User;
import net.suuku.gateway.repository.AuthorityRepository;
import net.suuku.gateway.repository.UserRepository;
import net.suuku.gateway.security.SecurityUtils;
import net.suuku.gateway.service.dto.AdminUserDTO;
import net.suuku.gateway.service.dto.UserDTO;
...
public class UserService {
    ...
    public Mono<AdminUserDTO> getUserFromAuthentication(AbstractAuthenticationToken authToken) {
        ...
        if (authToken instanceof OAuth2AuthenticationToken token) {
        	...
        	LOG.info("Illegal ArgumentExceptionToken: {}", authToken);
