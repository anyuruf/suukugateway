package net.suuku.gateway.repository;

import io.r2dbc.spi.Row;
import io.r2dbc.spi.RowMetadata;
import java.util.List;
import net.suuku.gateway.domain.Customer;
import net.suuku.gateway.repository.rowmapper.CustomerRowMapper;
import net.suuku.gateway.repository.rowmapper.UserRowMapper;
...
class CustomerRepositoryInternalImpl extends SimpleR2dbcRepository<Customer, Long> implements CustomerRepositoryInternal {
    ...
    private static final Table userTable = Table.aliased("jhi_user", "s_user");
